...
exports.validateIdentityLogin = exports.validateIdentityRegistration = void 0;
...
const validateIdentityLogin = (data) => {
    const schema = joi_1.default.object({
        email: joi_1.default.string().email().required(),
        password: joi_1.default.string().min(6).required()
    });
...
exports.validateIdentityLogin = validateIdentityLogin;
